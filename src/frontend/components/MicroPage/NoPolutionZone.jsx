            ...
            noPollutionZone.map((single, index)=>(
              <div key={index} className='col-sm-12 col-md-4 col-lg-4'>
                <div className="card center" onClick={() => setIndex(index)}>
                  <img src={CONFIG.IMAGE_URL + 'no-pollution/'+single.imgSrc} alt="" className="img-fluid d-md-none" />
                  <img src={CONFIG.IMAGE_URL + 'no-pollution/'+single.imgSrc} alt="" className="img-fluid d-none d-md-block" />
                  <Watermark />
                </div>
                <div className="content">
