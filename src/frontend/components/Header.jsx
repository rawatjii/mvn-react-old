          ...
          <div id="basic-navbar-nav" className='navbar_collapse' ref={menusRef}>
            <Container>
              ...
              <ul className="menus">
                ...
                <li className='nav-link'>
                  ...
                  <ul className='sub_menu'>
                    <li className='nav-link'>
                      ...
                      <NavLink className="new-launch">MVN Mall <span className='status'>New Launch</span></NavLink>
                      <NavLink className="new-launch">MVN Aero One <span className='status'>New Launch</span></NavLink>
                    </li>
                ...
                <li className='nav-link'>
                  ...
                  <ul className='sub_menu'>
                    <li className='nav-link'>
                      ...
                      <NavLink>MVN School, Sector 88, Greater Faridabad</NavLink>
                    </li>
                ...
                <li className='nav-link'>
                  <NavLink to="/mvn/contact-us" onClick={()=>toggleMenu('close')}>Contact Us</NavLink>
                </li>
                ...
                <ul className='sub_menu'>
                    <li>
                      ...
                      <ul className='social_links'>
                        <li>
                          <Link><img src={`${CONFIG.IMAGE_URL + 'social/fb.png'}`} alt="mvn-fb-icon" /></Link>
                        </li>
                        <li>
                          <Link><img src={`${CONFIG.IMAGE_URL + 'social/instagram.png'}`} alt="mvn-insta-icon" /></Link>
                        </li>
                        <li>
                          <Link><img src={`${CONFIG.IMAGE_URL + 'social/linkedin.png'}`} alt="mvn-linkedin-icon" /></Link>
                        </li>
                        <li>
                          <Link><img src={`${CONFIG.IMAGE_URL + 'social/youtube.png'}`} alt="mvn-youtube-icon" /></Link>
                        </li>
                      </ul>
                    </li>
                  </ul>
